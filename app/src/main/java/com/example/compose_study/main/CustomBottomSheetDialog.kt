...
class BottomSheetBehaviorProperties(
    ...
    value class PeekHeight(val value: Int) {
        ...
        companion object {
            @Stable
            val Auto = PeekHeight(BottomSheetBehavior.PEEK_HEIGHT_AUTO)
        }
    }
}
...
private class BottomSheetDialogWrapper(
    ...
    private val bottomSheetCallbackForAnimation: BottomSheetBehavior.BottomSheetCallback = object : BottomSheetBehavior.BottomSheetCallback() {
    ...
    private fun setBehaviorProperties(behaviorProperties: BottomSheetBehaviorProperties) {
        this.behavior.state = when (behaviorProperties.state) {
            BottomSheetBehaviorProperties.State.Expanded -> BottomSheetBehavior.STATE_EXPANDED
            BottomSheetBehaviorProperties.State.Collapsed -> BottomSheetBehavior.STATE_COLLAPSED
            BottomSheetBehaviorProperties.State.HalfExpanded -> BottomSheetBehavior.STATE_HALF_EXPANDED
        }
